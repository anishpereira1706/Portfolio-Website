...
const About = () => {
  return (
    <section id="about" className="w-full py-24 sm:py-32 border-y border-white/5 relative">
      ...
      <div className="absolute left-0 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-cyan-600/5 rounded-full blur-[120px] pointer-events-none z-0"></div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <div className="bg-gradient-to-br from-zinc-900/90 to-zinc-950/90 backdrop-blur-xl border border-white/5 p-6 sm:p-8 md:p-12 rounded-3xl sm:rounded-[2rem] text-zinc-300 space-y-6 text-lg leading-relaxed hover:border-cyan-500/30 transition-all duration-500 hover:shadow-[0_0_50px_rgba(34,211,238,0.1)] group relative overflow-hidden flex flex-col">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 pt-10 mt-8 border-t border-white/5 relative z-20">
              <div>
                <h3 className="text-2xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-zinc-200 to-zinc-400 font-heading group-hover:from-cyan-400 group-hover:to-blue-500 transition-all duration-500">Education</h3>
                <ul className="space-y-4 text-sm">
                  <li className="flex flex-col bg-gradient-to-br from-zinc-900/80 to-zinc-950/80 p-5 rounded-2xl border border-white/5 hover:border-cyan-500/40 hover:bg-cyan-500/5 hover:-translate-y-1 hover:shadow-[0_0_20px_rgba(34,211,238,0.1)] transition-all duration-300 cursor-default">
              ...
              <div>
                <h3 className="text-2xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-zinc-200 to-zinc-400 font-heading group-hover:from-cyan-400 group-hover:to-blue-500 transition-all duration-500">Certifications</h3>
                <ul className="space-y-4 text-sm text-zinc-400">
                  <li className="flex items-start gap-4 bg-gradient-to-br from-zinc-900/80 to-zinc-950/80 p-5 rounded-2xl border border-white/5 hover:border-cyan-500/40 hover:bg-cyan-500/5 hover:-translate-y-1 hover:shadow-[0_0_20px_rgba(34,211,238,0.1)] transition-all duration-300 cursor-default">
