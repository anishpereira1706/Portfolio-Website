  ...
  return (
    <section id="experience" className="w-full py-24 sm:py-32 border-y border-white/5 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-transparent bg-clip-text bg-linear-to-r from-cyan-400 to-blue-500 font-heading">Experience</h2>
            ...
            >
              ...
              >
                ...
                <div className="flex flex-col xl:flex-row xl:items-center justify-between mb-4 gap-3 relative z-10">
                  <h3 className="font-bold text-2xl text-transparent bg-clip-text bg-linear-to-r from-zinc-200 to-zinc-400 font-heading group-hover:from-cyan-400 group-hover:to-blue-500 transition-all duration-500">{exp.role}</h3>
